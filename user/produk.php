...
<head>
    ...
    <link rel="stylesheet" href="css/stylesheet_produk.css">
...
<body>
    ...
    <div class="album py-5">
        <div class="container">
            ...
            if (isset($_POST['cari'])) {
                $cari = $_POST['cari'];
                $query_produk = mysqli_query($koneksi, "select * from produk where nama_produk like '%$cari%' or kategori like '%$cari%' or merek like '%$cari%'");
            }
            else{
