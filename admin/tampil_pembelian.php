        ...
        <div class='card-body'>
            <table class="table table-bordered fs-5 fw-light text-center">
                ...
                if (isset($_POST["cari"])) {
                    ...
                    $query_transaksi= mysqli_query($koneksi,"SELECT * from transaksi join pelanggan on pelanggan.id_pelanggan= transaksi.id_pelanggan ORDER BY id_transaksi DESC;") or die (mysqli_error($koneksi));
                }
                    $no=0;
                    ...
                    <tr>
                        ...
                        <td><a href="hapus_pembelian.php?id_transaksi=<?=$data_transaksi ['id_transaksi']?>" onclick="return confirm('Are you sure want to delete this order?')"><i class="fa-solid fa-trash text-red"></i></a> </td>      
                        <?php
