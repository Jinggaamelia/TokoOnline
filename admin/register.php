    ...
    <div class="container">
        <div class="row content g-0">
                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../user/images/gucci3.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="../user/images/gucci1.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="../user/images/gucci2.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 px-5 pt-5">
                <div class="mb-3">
                    <img src="./images/logo gucci.jpeg" alt="" width="70%">
                </div>
                <h3>Register</h3>
